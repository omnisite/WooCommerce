...
if ( ! class_exists( 'Wc_Buckaroo_Bpe_Gateway_Settings' ) ) {

	class Wc_Buckaroo_Bpe_Gateway_Settings extends WC_Settings_Page {
...
return new Wc_Buckaroo_Bpe_Gateway_Settings(
